...
\abstract{
  ...
  Thia precission will be achieved thanks to the Particle Flow algorithms (PF) which require compact, highly granular and hermetic calorimeters systems.
  ...
  In this article we present the commissioning and the performance of the prototype in a beam test carried at DESY in June 2017.
}
